...
import { ALLOW_FILE_UPLOAD, ALLOW_VOICE_RECOGNITION, ALLOW_FAQ, BEDROCK_API_URL } from "../utilities/constants";
...
function ChatBody() {
  ...
  return (
    <>
      <Box display="flex" flexDirection="column" justifyContent="space-between" className="appHeight100 appWidth100" sx={{ mt : 3}}>
